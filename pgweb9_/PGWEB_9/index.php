            ...
            <table>
                ...
                <?php foreach ($data as $row): ?>
                    <tr>
                        ...
                        <td>
                            <!-- Form Edit -->
                            <a href="edit.php?kecamatan=<?= urlencode($row['kecamatan']) ?>" style="background-color: #608BC1; color: white; padding: 5px; border-radius: 3px; text-decoration: none;">Edit</a>
                            <!-- Form Hapus -->
                            <form method="GET" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus kecamatan <?= htmlspecialchars($row['kecamatan']) ?>?');">
                                ...
                                <button type="submit" style="background-color: #ff6b6b; color: white; border: none; padding: 5px 10px; cursor: pointer; border-radius: 3px;">Hapus</button>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; ?>
